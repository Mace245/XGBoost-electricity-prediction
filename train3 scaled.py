...
model_scaled = xgb.XGBRegressor(
    objective='reg:squarederror',
    n_estimators=1000,      # 3000/28.96    2000/28.644     1000/28.121
    learning_rate=0.1,     # 0.01/28.121   0.05/32.21      0.1/30.949
    max_depth=7,            # 7/28.121      5/27.139        3/25.906      
    colsample_bytree=1.0,   # 1.0/25.906    0.5/27.134      0.1/31.779
    subsample=0.1,          # 0.1/28.121    0.3/26.511      0.5/27.004      1.0/28.165
    reg_alpha=5.0,          # 0.0/26.529    0.1/26.529      0.5/26.574      1.0/26.568      5.0/26.511     10.0/28.054
...
print("Training the scaled XGBoost model...")
model_scaled.fit(
...
model_scaled.save_model('final_scaled_xgboost_model.ubj')

print("Loading model and making predictions...")
loaded_model = xgb.XGBRegressor()
loaded_model.load_model('final_scaled_xgboost_model.ubj')
...
print(f"Final scaled Model MAPE on Test Set: {mape_score * 100:.3f}%")
